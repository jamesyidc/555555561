#!/usr/bin/env python3
"""
Price Speed JSONL Manager - 价格速度数据管理
"""
import json
import os
...
class PriceSpeedJSONLManager:
    ...
    def __init__(self, data_dir='/home/user/webapp/data/price_speed_jsonl'):
        self.data_dir = Path(data_dir)
        self.data_dir.mkdir(parents=True, exist_ok=True)
    
    def get_latest_speed(self, symbol=None, limit=100):
        """获取最新的价格速度数据"""
        try:
            all_data = []
            ...
            print(f"[PriceSpeedJSONLManager] 获取数据失败: {e}")
            return []
